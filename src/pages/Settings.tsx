    ...
    <Stack gap="md">
      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Group mb="md">
          ...
          <Text size="lg" fw={600}>服务器配置</Text>
        </Group>
        <Stack gap="md">
      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Group mb="md">
          ...
          <Text size="lg" fw={600}>API Key 管理</Text>
        </Group>
        <Stack gap="md">
          <Text size="sm" c="dimmed">
      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Group mb="md">
          ...
          <Text size="lg" fw={600}>API 端点</Text>
        </Group>
        <Stack gap="sm">
          <div>
            <Text size="sm" fw={500} mb={4}>OpenAI 兼容接口</Text>
            <Code block>POST http://127.0.0.1:8080/v1/chat/completions</Code>
          </div>
          <div>
            <Text size="sm" fw={500} mb={4}>Anthropic 兼容接口</Text>
            <Code block>POST http://127.0.0.1:8080/v1/messages</Code>
          </div>
          <div>
            <Text size="sm" fw={500} mb={4}>模型列表</Text>
            <Code block>GET http://127.0.0.1:8080/v1/models</Code>
          </div>
          <div>
            <Text size="sm" fw={500} mb={4}>健康检查</Text>
      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Group mb="md">
          ...
          <Text size="lg" fw={600}>关于</Text>
        </Group>
        <Stack gap="xs">
          <Group>
            <Text size="sm" fw={500}>项目名称:</Text>
          ...
          <Group>
            <Text size="sm" fw={500}>技术栈:</Text>
            <Text size="sm">Tauri 2.0 + Rust + React + Mantine</Text>
          </Group>
          <Group>
            <Text size="sm" fw={500}>描述:</Text>
